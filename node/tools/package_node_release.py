...
Pico. Keep the Pico, ADXL355 board, and RS485 HAT grounds common.

## RS485 Wiring

RS485 connects through the HAT, so no separate Pico GPIO jumper wiring is
needed in the release harness. Connect the external RS485 A/B pair according to
the HAT markings, and keep polarity consistent across the bus.
""",
        encoding="utf-8",
    )
